...
//alert("/pro_line/newlinelist.asp?cid="+b+"&mid="+c+"&pid="+d+"&did="+e+"&moid="+f+"&zid="+h+"&bigid="+g+"&tid="+i+"&kid="+k+"&nkid="+nk);
jQuery.ajax({
...
$(function(){
var allguide="<div class=\"allmdd\"  style=\"display: none;\"><dl><dt class=\"a_ouzhou\"><a href=\"/ouzhou_t/\" target=\"_blank\">欧洲</a><a href=\"/meizhou_t/\" target=\"_blank\">美洲</a></dt><dd><a href=\"/guide/france.htm\" target=\"_blank\">法国</a><a href=\"/guide/switzerland.htm\" target=\"_blank\">瑞士</a><a href=\"/guide/italy.htm\" target=\"_blank\">意大利</a><a href=\"/guide/usa.htm\" target=\"_blank\">美国</a></dd><div class=\"a_ouzhou_item cats\"><div class=\"in_showbox\"><span><a href=\"/ouzhou_t/\" target=\"_blank\">欧洲</a></span><a target=\"_blank\" href=\"/guide/france.htm\">法国</a><a target=\"_blank\" href=\"/guide/switzerland.htm\">瑞士</a>"
...
+"<div class=\"in_showbox_i\"><span>推荐玩法</span><a target=\"_blank\" href=\"/guide/australia-168/\">澳大利亚+新西兰</a><a target=\"_blank\" href=\"/guide/australia-165/\">澳大利亚+凯恩斯+墨尔本</a><a target=\"_blank\" href=\"/guide/australia-166/\">澳大利亚+新西兰+凯恩斯</a><a target=\"_blank\" href=\"/guide/dibailvyou-219/\">迪拜+阿布扎比+沙迦</a><a target=\"_blank\" href=\"/guide/southafrica-579/\">南非+1国</a><a target=\"_blank\" href=\"/guide/morocco-7488/\">摩洛哥+1国</a><a target=\"_blank\" href=\"/guide/egypt-345/\">埃及+1国</a><a target=\"_blank\" href=\"/guide/turkey-405/\">土耳其+1国</a><a target=\"_blank\" href=\"/guide/yiselie-185/\">以色列+约旦</a></div></div></dl>"
...
$(function(){
	$(".cell-submit-button").click(function(){if ($("#starttime").val()==""){$("#starttime").focus();alert("请填写出行日期");;return false};
	if ($("#rennum").val()==0){$("#rennum").focus();alert("请选择要出游人数");;return false};
	if ($("#lx_name").val()==""){$("#lx_name").focus();alert("请填写联系人");;return false};
if ($("#lx_pho").val()==""){$("#lx_pho").focus();alert("请填手机号码");return false}else{var regExpjj=/13[0-9]{1}[0-9]{8}|18[0-9]{1}[0-9]{8}|15[0-9]{1}[0-9]{8}|17[0-9]{1}[0-9]{8}/;
	if(!regExpjj.test($("#lx_pho").val()) || $("#lx_pho").val().length !=11 ){$("#lx_pho").focus();alert("请填写正确的手机号码");return false;}
	};jQuery.ajax({
url:"/diyreceive.do",
type:"POST",
...
$(function(){$("#search_iStarplace").focus(function(){
	...
	if (nowid=='' || nowid=='欧洲' || nowid=='春节' || nowid=='暑假' || nowid=='日本' || nowid=='十一' || nowid=='十一旅游'){$(".resou").remove();
	$.ajax({	
...
function Hslide(){
    ...
    $(window).scroll(function() {
        ...
        if (st > tabtop) {
		  ...
		  if (st > tabflag){tab.css('display','none').stop().animate({opacity: 0}, 400)}else{tab.css('display','block').stop().animate({opacity: 1}, 400)}
       } else {
           tab.css('position','static').stop().animate({ top: 0 ,opacity: 1}, 400);
       }
        var itemlist = $(".t_hd");
