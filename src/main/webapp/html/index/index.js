...
var container = document.getElementsByClassName("sliderContainer");
...
var index = 0;
var dots = document.getElementById("buttonSpan").getElementsByTagName("span");
...
for (var i = 0, len = dots.length; i < len; i++){
    (function(i){
        dots[i].onclick = function () {
            var dis = index - i;
            if(index == 4 && parseInt(wrapImg.style.left)!==-3000){
                dis = dis - 5;
            }
